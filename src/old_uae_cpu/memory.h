...
#define m_real_address		" add 4,%1,%2 \n"		// %1 = addr, %2=MEMBaseDiff
#define m_virtual_address	" subf 4,%2,%1 \n"	// %1 = addr, %2=MEMBaseDiff
#define m_put_byte		" stb	%0,0(4) \n"		// %0 = value, %1 =addr
#define m_put_word		" sth	%0,0(4) \n"		// %0 = value, %1 =addr
#define m_put_long		" stw	 %0,0(4) \n"		// %0 = value, %1 =addr
#define m_get_byte		" lbz	%0,0(4) \n"		// %0 = value, %1 =addr
#define m_get_word		" lhz	%0,0(4) \n"		// %0 = value, %1 =addr
#define m_get_long		" lwz	 %0,0(4) \n"		// %0 = value, %1 =addr
...
#define do_get_real_address( addr )	 (uae_u8 *) (MEMBaseDiff + addr)
#define do_get_virtual_address( addr )	 (uae_u32) ((uintptr)addr - MEMBaseDiff)
...
//    return do_get_mem_long_asm(m,ret);
...
#define put_long( addr,  l)		 \
	asm						\
	(						\
		m_real_address		\
		m_put_long			\
		:: "r" (l), "r" (addr), "r" (MEMBaseDiff) : "r4"\
	);						\

#define put_word( addr,  l)		 \
	asm						\
	(						\
		m_real_address		\
		m_put_word			\
