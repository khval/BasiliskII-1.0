...
extern void timer_current_time(struct TimeVal &t);
extern void timer_add_time(struct TimeVal &res, struct TimeVal a, struct TimeVal b);
extern void timer_sub_time(struct TimeVal &res, struct TimeVal a, struct TimeVal b);
extern int timer_cmp_time(struct TimeVal a, struct TimeVal b);
extern void timer_mac2host_time(struct TimeVal &res, int32 mactime);
extern int32 timer_host2mac_time(struct TimeVal hosttime);
