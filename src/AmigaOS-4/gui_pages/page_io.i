PAGE_Add, VGroupObject,
	...
	LAYOUT_AddChild, VGroupObject,
		...
		LAYOUT_AddChild, MakeInteger_min_max(ID_PREFS_ETHERNET_UNIT_GAD, 0,0,128),
		...
		LAYOUT_AddChild, MakeCheckR(ID_PREFS_ETHERNET_MONITOR_GAD, FALSE),
	...
	LAYOUT_AddChild, VGroupObject,
		...
		LAYOUT_AddChild, HGroupObject,
			...
			LAYOUT_AddChild, MakeInteger_min_max(ID_PREFS_MODEM_UNIT_GAD, 0,0,128),
			//LAYOUT_AddChild, MakeCheck(ID_PREFS_MODEM_PARALLEL_GAD, 0),
			//CHILD_Label, MakeLabel(ID_PREFS_MODEM_PARALLEL_GAD),
			LAYOUT_AddChild, MakeCheckL(ID_PREFS_MODEM_PARALLEL_GAD, FALSE),
		LayoutEnd,
	...
	LAYOUT_AddChild, VGroupObject,
		...
		LAYOUT_AddChild, HGroupObject,
			...
			LAYOUT_AddChild, MakeInteger_min_max(ID_PREFS_PRINTER_UNIT_GAD, 0,0,128),
			//LAYOUT_AddChild, MakeCheck(ID_PREFS_PRINTER_PARALLEL_GAD, 0),
			//CHILD_Label, MakeLabel(ID_PREFS_PRINTER_PARALLEL_GAD),
			LAYOUT_AddChild, MakeCheckL(ID_PREFS_PRINTER_PARALLEL_GAD, FALSE),
		LayoutEnd,
