...
extern void *get_convert( uint32 scr_depth, uint32 depth );
extern void *get_convert_v2( uint32 scr_depth, uint32 depth );
...
#define convert_type fnPtrGfxConvert 
#endif
